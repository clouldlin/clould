...
public class PropertyFileReaderTest {
	...
	public void centos_database_property_file_read(){
		...
		assertThat(property.prop.getProperty(DATABASE_URL), is("jdbc:mariadb://14.63.171.133:3306/clould"));
		assertThat(property.prop.getProperty(DATABASE_USERNAME), is("clould"));
		assertThat(property.prop.getProperty(DATABASE_PASSWORD), is("clould"));
